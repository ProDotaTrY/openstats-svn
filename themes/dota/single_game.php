...
<?php if ($PlayerKills>0) { ?> 
    <tr class="row"  height="26" >
	  <td width="180"class="padLeft"><h4 class="best_player_title"><?=$lang["best_player"] ?></span></h4>
	  <td width="180" class="padLeft" style="text-align:left;"><h4 class="best_player">
	   <a href="<?=$website?>?u=<?=strtolower($BestPlayer)?>"><?=$BestPlayer?></a> <img src="<?=$website?>img/winner.png" class="imgvalign" width="24" height="24" /> 
	   </h4></td>
	  <td></td>
	</tr>  
    <tr class="row">
